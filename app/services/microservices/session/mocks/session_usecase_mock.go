...
func (m *MockUseCase) Create(sess models.Session) error {
	m.ctrl.T.Helper()
...
func (mr *MockUseCaseMockRecorder) Create(sess interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockUseCase)(nil).Create), sess)
}

// Get mocks base method
func (m *MockUseCase) Get(sid string) (uint, error) {
	m.ctrl.T.Helper()
