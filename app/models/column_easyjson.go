	...
	for !in.IsDelim('}') {
		...
		case "comments":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v8 Comment
					easyjsonE1a760eeDecodeGithubComGoParkMailRu20201SIBIRSKAYAKORONAAppModels4(in, &v8)
		...
		case "labels":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v10 Label
					easyjsonE1a760eeDecodeGithubComGoParkMailRu20201SIBIRSKAYAKORONAAppModels5(in, &v10)
...
func easyjsonE1a760eeEncodeGithubComGoParkMailRu20201SIBIRSKAYAKORONAAppModels2(out *jwriter.Writer, in Task) {
	...
	if len(in.Members) != 0 {
		...
		out.RawString(prefix)
		{
			...
			for v11, v12 := range in.Members {
				...
				easyjsonE1a760eeEncodeGithubComGoParkMailRu20201SIBIRSKAYAKORONAAppModels3(out, v12)
			}
			out.RawByte(']')
		}
	}
	if len(in.Comments) != 0 {
		...
		out.RawString(prefix)
		{
			...
			for v13, v14 := range in.Comments {
				...
				easyjsonE1a760eeEncodeGithubComGoParkMailRu20201SIBIRSKAYAKORONAAppModels4(out, v14)
			}
			out.RawByte(']')
		}
	}
	if len(in.Checklists) != 0 {
		...
		{
			out.RawByte('[')
			for v15, v16 := range in.Checklists {
				if v15 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.Labels) != 0 {
		...
		out.RawString(prefix)
		{
			...
			for v17, v18 := range in.Labels {
				...
				easyjsonE1a760eeEncodeGithubComGoParkMailRu20201SIBIRSKAYAKORONAAppModels5(out, v18)
			}
			out.RawByte(']')
		}
	}
...
func easyjsonE1a760eeDecodeGithubComGoParkMailRu20201SIBIRSKAYAKORONAAppModels5(in *jlexer.Lexer, out *Label) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonE1a760eeEncodeGithubComGoParkMailRu20201SIBIRSKAYAKORONAAppModels5(out *jwriter.Writer, in Label) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonE1a760eeDecodeGithubComGoParkMailRu20201SIBIRSKAYAKORONAAppModels4(in *jlexer.Lexer, out *Comment) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonE1a760eeEncodeGithubComGoParkMailRu20201SIBIRSKAYAKORONAAppModels4(out *jwriter.Writer, in Comment) {
	out.RawByte('{')
	first := true
	_ = first
	{
